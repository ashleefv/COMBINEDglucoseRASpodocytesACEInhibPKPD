...
renalfunction = 'normal';
 ...
 %renalfunction = 'impaired';
   tstart_dosing = 24*0;
    ...
    ANGII_Plot = 16.524761904761903; %initial conc used to normalize in figure 3
...
call_PKPD_model_scalar(coefficients,tfinal_dosing,sim_time_end,plot_mode,...
    layer_plots,drugdose,tau,drugname,renalfunction,linestylestring,tstart_dosing,linewidth,...
    legendlocation,ANGII_Plot,color);
