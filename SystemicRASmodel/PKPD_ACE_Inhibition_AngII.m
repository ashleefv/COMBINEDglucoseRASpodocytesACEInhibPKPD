...
function output = PKPD_ACE_Inhibition_AngII(coefficients, drugdose,...
    ...
    drug_conc_t0,k_degr_Renin,k_degr_AngI,Mw_AngI,Mw_AngII,Mw_Renin,sim_time_end,tstart_dosing)
...
if tfinal_dosing(end) == 0
    ...
    [t,conc] = ode45(@(t,conc) ODE(t,conc,drugdose,ke_diacid,...
            ...
            k_degr_Renin,k_degr_AngI,k_cons_AngII,tstart_dosing),time,conc_t0,options);
...
function d_conc_dt = ODE(t,conc,drugdose,ke_diacid,VF_diacid,ka_diacid,...
    ...
    Renin_conc_t0,baseline_prod_Renin,k_degr_Renin,k_degr_AngI,k_cons_AngII,tstart_dosing)
